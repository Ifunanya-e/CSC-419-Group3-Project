    ...
    return (
        <div className="bg-white w-full py-3 border-b border-gray-200">
            <div className="flex items-center justify-between lg:justify-around px-4 md:px-6">
                ...
                {/* Register Info */}
                <p className="font-semibold text-gray-700 text-sm md:text-base">Register: 01-310</p>

                {/* Search Bar - Hidden on mobile */}
                <section className="hidden md:flex space-x-2 rounded-lg border border-gray-300 px-3 py-2 w-1/3 focus-within:outline">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" className="fill-black cursor-pointer">
                ...
                <section className="flex space-x-2 md:space-x-4">
                    ...
                    {/* Bell Icon */}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 md:w-6 md:h-6 cursor-pointer hover:fill-[#000435] hover:text-[#000435] transition duration-150">
