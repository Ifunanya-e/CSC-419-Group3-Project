...
function Sidebar({ isExpanded: propIsExpanded, setIsExpanded, isMobileMenuOpen, setIsMobileMenuOpen }) {
    ...
    const menuItems = [
        { name: 'Dashboard', icon: 'dashboard', page: 'dashboard', path: '/' },
        { name: 'Inventory Management', icon: 'inventory', page: 'products', path: '/products' },
        { name: 'Shipment', icon: 'shipment', page: 'shipment', path: '/shipment' },
        { name: 'Cashier', icon: 'cashier', page: 'cashier', path: '/cashier' },
    ];
        ...
        const icons = {
            dashboard: (
                <svg width="27" height="28" viewBox="0 0 27 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.65729 11.4005H3.74197C3.02073 11.3946 2.32666 11.6754 1.81246 12.1811C1.29824 12.6869 1.00601 13.3761 1.00006 14.0973V24.3041C1.01341 25.8054 2.24075 27.0118 3.74197 26.9992H8.65729C9.37847 27.0053 10.0726 26.7245 10.5869 26.2187C11.1011 25.713 11.3933 25.0237 11.3992 24.3023V14.0973C11.3933 13.3761 11.1011 12.6869 10.5869 12.1811C10.0726 11.6754 9.37847 11.3946 8.65729 11.4005Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.65729 1.00105H3.74197C2.27094 0.960247 1.04441 2.11778 1.00006 3.5887V5.34615C1.04441 6.81709 2.27094 7.97462 3.74197 7.93381H8.65729C10.1283 7.97462 11.3548 6.81709 11.3992 5.34615V3.5887C11.3548 2.11778 10.1283 0.960247 8.65729 1.00105Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.6074 16.6008H22.521C23.2426 16.6072 23.9371 16.3266 24.4516 15.8209C24.9662 15.315 25.2588 14.6255 25.2647 13.904V3.69889C25.2588 2.97768 24.9666 2.28835 24.4523 1.78259C23.9381 1.27683 23.244 0.99605 22.5228 1.00205H17.6074C16.8863 0.99605 16.1921 1.27683 15.6779 1.78259C15.1636 2.28835 14.8714 2.97768 14.8655 3.69889V13.904C14.8714 14.6252 15.1636 15.3145 15.6779 15.8202C16.1921 16.3259 16.8863 16.6067 17.6074 16.6008Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M17.6074 26.9983H22.521C23.9927 27.04 25.2203 25.8823 25.2647 24.4106V22.6532C25.2203 21.1822 23.9937 20.0248 22.5228 20.0655H17.6074C16.1365 20.0248 14.9099 21.1822 14.8655 22.6532V24.4089C14.9089 25.8805 16.1358 27.039 17.6074 26.9983Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            ),
            inventory: (
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
                    <path d="M480-120 80-406v-434h800v434L480-120Zm0-108 320-214v-302H160v302l320 214Zm0-214Z"/>
                </svg>
            ),
            shipment: (
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
                    <path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h240l60-60h240l60 60h240q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm0-80h640v-480H560l-60-60H360l-60 60H160v480Zm320-240Z"/>
                </svg>
            ),
            cashier: (
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
                    <path d="M280-280h400v-80H280v80Zm0-160h400v-80H280v80ZM120-120v-80h720v80H120Zm80-160h560v-560H200v560Z"/>
                </svg>
            ),
        };
    ...
    return (
        <>
            ...
            <nav className="mt-8 space-y-2 px-3">
                {menuItems.map((item) => (
                    ...
                    >
                        ...
                        {isExpanded && <span className="text-sm font-medium text-left">{item.name}</span>}
                    </Link>
                ))}
            </nav>
            ...
            <div className="absolute bottom-6 left-0 right-0 px-3">
                <div className={`flex flex-col items-center ${isExpanded ? 'space-x-3' : 'justify-center'} p-3 rounded-lg bg-gray-800`}>
