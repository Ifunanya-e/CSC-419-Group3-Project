            ...
            >
                ...
                <div className="flex items-center justify-center p-4 border-b border-gray-700">
                    <Link to="/admin/dashboard" className="block">
                        {expanded && (
                            <svg width="201" height="78" viewBox="0 0 201 78" fill="none" className="w-36 cursor-pointer hover:opacity-80 transition-opacity" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={`flex flex-col items-center ${expanded ? 'space-x-3' : 'justify-center'} p-3 rounded-lg bg-gray-800`}>
                        ...
                        {expanded && (
                            <div className="flex-1 text-center mt-2">
                                <p className="text-sm font-semibold">{user?.role?.charAt(0).toUpperCase() + user?.role?.slice(1) || 'Admin'}</p>
                                <p className="text-sm text-gray-300">{user?.full_name || 'User'}</p>
